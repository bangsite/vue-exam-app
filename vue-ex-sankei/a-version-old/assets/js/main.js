...
$(document).ready(function () {
    ...
    // Form input
    // let practice = document.querySelector('input[name="practice"]:checked').value;
     let question9 = $('#education');
     let question10 = $('#request');

    $('#surveyForm').on('change', function() {
        let value= $('input[name="practice"]:checked').val();
        localStorage.setItem('practiceStar', value);

    });


    $("#submit").click(function () {
        localStorage.setItem('question9', question9.val());
        localStorage.setItem('question10', question10.val());
